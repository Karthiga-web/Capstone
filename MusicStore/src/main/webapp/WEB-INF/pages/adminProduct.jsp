...
<div align="center">
            ...
            <table>
                ...
                <c:forEach var="product" items="${products}">
                    <tr>
                        ...
                        <td>${product.price}</td>
                        <td><a type="button" class="btn btn-success" href="/admin-delete/${product.id}">Delete</a></td>
                        <td><a type="button" class="btn btn-success" href="/admin-update/${product.id}">Update</a></td>
                    </tr>
                </c:forEach>
            </table>
        </form>
    ...
    <div>
        <a href="viewdetail/${product.id}">Add Product</a>
    </div>
</div>
